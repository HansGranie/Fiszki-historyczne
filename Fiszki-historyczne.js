...
const Questions = [
    ...
    {question: "Jakie były dwa główne bloki polityczne przed I wojną światową?", answer: "Trójprzymierze i Trójporozumienie.", era:"współczesność"},
    {question: "Które państwa należały do Trójprzymierza?", answer: "Niemcy, Austro-Węgry, Włochy.", era:"współczesność"},
    {question: "Które państwa tworzyły Trójporozumienie?", answer: "Francja, Rosja, Wielka Brytania.", era:"współczesność"},
    {question: "Jaki był bezpośredni pretekst wybuchu I wojny światowej?", answer: "Zamach w Sarajewie (1914 r.).", era:"współczesność"},
    ...
    {question: "Kiedy podpisano rozejm kończący Wielką Wojnę?", answer: "11 listopada 1918 r.", era:"współczesność"},
    {question: "Czym był traktat wersalski?", answer: "Układem pokojowym z Niemcami (1919 r.).", era:"współczesność"},
    {question: "Jaki traktat państwa ententy zawarły z Węgrami w 1920?", answer: "Traktat w Trianon.", era:"współczesność"},
    {question: "Czym była Liga Narodów?", answer: "Organizacją międzynarodową mającą utrzymać pokój.", era:"współczesność"},
    {question: "Jakie orientacje polityczne istniały wśród Polaków w czasie I wojny światowej?", answer: "Proaustriacka i prorosyjska.", era:"współczesność"},
    {question: "Kto reprezentował orientację proaustriacką Polaków?", answer: "Józef Piłsudski.", era:"współczesność"},
    {question: "Jaką orientację Polaków reprezentował Roman Dmowski?", answer: "Orientację prorosyjską.", era:"współczesność"},
    {question: "Czym były Legiony Polskie?", answer: "Formacją wojskową walczącą u boku Austriaków pod dowództwem Piłsudskiego.", era:"współczesność"},
    {question: "Czym był Akt 5 listopada 1916 r.?", answer: "Zapowiedzią utworzenia Królestwa Polskiego przez cesarzy Niemiec i Austro-Węgier.", era:"współczesność"},
    {question: "Jakie wydarzenie uznaje się za moment odzyskania niepodległości przez Polskę?", answer: "Przekazanie władzy wojskowej Piłsudskiemu przez Radę Regencyjną.", era:"współczesność"},
    {question: "Kto został pierwszym premierem II RP?", answer: "Jędrzej Moraczewski.", era:"współczesność"},
    {question: "Czym była wojna polsko-bolszewicka?", answer: "Konfliktem z Rosją sowiecką w latach 1919–1921.", era:"współczesność"},
    {question: "Jaki był kluczowy manewr wojskowy Piłsudskiego w Bitwie Warszawskiej?", answer: "Kontratak znad Wieprza (16 sierpnia 1920).", era:"współczesność"},
    {question: "Jaki układ zakończył wojnę polsko-bolszewicką?", answer: "Pokój ryski (1921 r.).", era:"współczesność"},
    {question: "W jakim celu Bułgaria przystąpiła do państw centralnych (1915)?", answer: "W celu zaatakowania Serbii u boku Austro-Węgier.", era:"współczesność"},
    {question: "Dlaczego USA nie przystąpiły do Ligi Narodów?", answer: "Ponieważ Senat USA nie ratyfikował traktatu wersalskiego.", era:"współczesność"},
    {question: "W jakiej bitwie Niemcy zmusili Rosjan do odwrotu na froncie wschodnim I wojny światowej?", answer: "Bitwa pod Tannenbergiem (1914).", era:"współczesność"},
    {question: "Jakie imperia upadły w wyniku I wojny światowej?", answer: "Niemieckie, Austro-Węgierskie, Rosyjskie, Osmańskie.", era:"współczesność"},
    {question: "Dlaczego I wojna światowa była konfliktem totalnym?", answer: "Zaangażowała całe społeczeństwa i gospodarki.", era:"współczesność"},
    {question: "Jaki ustrój przyjęła Polska w konstytucji marcowej (1921 r.)?", answer: "Ustrój republiki parlamentarnej.", era:"współczesność"},
    {question: "Czym był zamach majowy (1926 r.)?", answer: "Przejęciem władzy przez Piłsudskiego w Polsce.", era:"współczesność"},
    {question: "Czym była sanacja?", answer: "Obozem piłsudczyków rządzących Polską po 1926 r.", era:"współczesność"},
    {question: "Czym była konstytucja kwietniowa (1935 r.)?", answer: "Wzmocnieniem władzy prezydenta Polski.", era:"współczesność"},
    {question: "Jakie wydarzenie rozpoczęło wielki kryzys gospodarczy (1929)?", answer: "Krach na giełdzie nowojorskiej.", era:"współczesność"},
    {question: "Jak Włosi nazywali swoją wygraną w I wojnie światowej?", answer: "Okaleczone zwycięstwo (vittoria mutilata).", era:"współczesność"},
    {question: "Kto był twórcą faszyzmu?", answer: "Benito Mussolini.", era:"współczesność"},
    {question: "W którym roku odbył się pucz monachijski?", answer: "W 1923 r.", era:"współczesność"},
    {question: "Kiedy NSDAP stała się największą partią w Reichstagu?", answer: "Po wyborach w lipcu 1932 r.", era:"współczesność"},
    {question: "W którym roku zmarł Lenin?", answer: "W 1924 r.", era:"współczesność"},
    {question: "W jakich latach trwała wojna domowa w Hiszpanii?", answer: "1936-1939.", era:"współczesność"},
    {question: "Co było bezpośrednim pretekstem wybuchu II wojny światowej?", answer: "Atak Niemiec na Polskę (1939).", era:"współczesność"},
    {question: "Kiedy ZSRR zaatakował Polskę?", answer: "17 września 1939 r.", era:"współczesność"},
    {question: "Kiedy zawarto pakt Ribbentrop-Mołotow?", answer: "23 sierpnia 1939 r.", era:"współczesność"},
    {question: "Czym był Holokaust?", answer: "Zagładą Żydów europejskich.", era:"współczesność"},
    {question: "Jaka była ostatnia bitwa kampanii wrześniowej?", answer: "Bitwa pod Kockiem.", era:"współczesność"},
    {question: "Czym była bitwa o Anglię?", answer: "Niemiecką ofensywą lotniczą nad Wielką Brytanią (1940 r.).", era:"współczesność"},
    {question: "Czym była operacja „Barbarossa”?", answer: "Atakiem Niemiec na ZSRR (1941 r.).", era:"współczesność"},
    {question: "Kiedy USA przystąpiły do II wojny?", answer: "Po ataku na Pearl Harbor (7 grudnia 1941 r.).", era:"współczesność"},
    {question: "Kiedy była konferencja w Jałcie?", answer: "W lutym 1945 r.", era:"współczesność"},
    {question: "Czym było Polskie Państwo Podziemne?", answer: "Tajną strukturą państwową w okupowanej Polsce.", era:"współczesność"},
    {question: "Gdzie odbyły się pierwsze walki powstania warszawskiego?", answer: "Na Żoliborzu.", era:"współczesność"},
    {question: "Kiedy zakończyła się II wojna światowa w Europie?", answer: "8 maja 1945 r.", era:"współczesność"},
    {question: "Kiedy Amerykanie zrzucili bombę atomową na Hiroszimę?", answer: "6 sierpnia 1945 r.", era:"współczesność"},
    {question: "Jaka była największa bitwa pancerna w historii?", answer: "Bitwa pod Kurskiem (1943).", era:"współczesność"},
    {question: "Ile wynosiły straty Polski w II wojnie światowej?", answer: "Około 6 mln obywateli.", era:"współczesność"},
    ...
    {question: "Czym była zimna wojna?", answer: "Rywalizacją pomiędzy USA i ZSRR.", era:"współczesność"},
    {question: "Jakie miasta europejskie podzielono na strefy okupacyjne po II wojnie światowej?", answer: "Berlin i Wiedeń.", era:"współczesność"},
    {question: "Czym była doktryna Trumana?", answer: "Polityką powstrzymywania komunizmu.", era:"współczesność"},
    {question: "Czym był plan Marshalla?", answer: "Programem pomocy finansowej USA dla Europy.", era:"współczesność"},
    {question: "Gdzie utworzono NATO w 1949?", answer: "W Waszyngtonie.", era:"współczesność"},
    {question: "Czym był Układ Warszawski?", answer: "Sojuszem państw bloku wschodniego.", era:"współczesność"},
    {question: "Kiedy zbudowano mur berliński?", answer: "13 sierpnia 1961 r.", era:"współczesność"},
    {question: "Kim byli przywódcy USA i ZSRR podczas kryzysu kubańskiego w 1962?", answer: "John F. Kennedy i Nikita Chruszczow.", era:"współczesność"},
    {question: "Kiedy umarł Józef Stalin?", answer: "5 marca 1953 r.", era:"współczesność"},
    {question: "W jakich latach trwała wojna w Korei?", answer: "W latach 1950-1953.", era:"współczesność"},
    {question: "Kto był pierwszym prezydentem Polski po II wojnie światowej?", answer: "Bolesław Bierut.", era:"współczesność"},
    {question: "Kiedy powstała PRL?", answer: "W 1952 r.", era:"współczesność"},
    {question: "Czym był stalinizm w Polsce?", answer: "Okresem terroru politycznego.", era:"współczesność"},
    {question: "Kto doszedł do władzy w PRL w październiku 1956?", answer: "Władysław Gomułka.", era:"współczesność"},
    {question: "Czym były wydarzenia marcowe 1968 r.?", answer: "Protestami studenckimi w Polsce i Europie.", era:"współczesność"},
    {question: "Gdzie odbywały się główne protesty grudnia 1970?", answer: "Na wybrzeżu Polski (Gdańsk, Gdynia, Szczecin).", era:"współczesność"},
    {question: "Kto był papieżem wybranym w 1978 r.?", answer: "Jan Paweł II.", era:"współczesność"},
    {question: "Kiedy powstała „Solidarność”?", answer: "31 sierpnia 1980 r.", era:"współczesność"},
    {question: "Kto był liderem „Solidarności”?", answer: "Lech Wałęsa.", era:"współczesność"},
    {question: "Kiedy wprowadzono stan wojenny w Polsce?", answer: "13 grudnia 1981 r.", era:"współczesność"},
    {question: "Kto był pierwszym prezydentem III RP?", answer: "Wojciech Jaruzelski.", era:"współczesność"},
    {question: "Kiedy trwały obrady Okrągłego Stołu?", answer: "Od lutego do kwietnia 1989 r.", era:"współczesność"},
    {question: "Kiedy odbyły się pierwsze częściowo wolne wybory w Polsce?", answer: "4 czerwca 1989 r.", era:"współczesność"},
    {question: "Kiedy upadł mur berliński?", answer: "9 listopada 1989 r.", era:"współczesność"},
    {question: "Kiedy rozwiązano ZSRR?", answer: "26 grudnia 1991 r.", era:"współczesność"},
    {question: "Kto doszedł do władzy w ZSRR w 1985 r.?", answer: "Michaił Gorbaczow.", era:"współczesność"},
    {question: "Kiedy zamordowano prezydenta Johna Kennedy'ego w Dallas?", answer: "22 listopada 1963 r.", era:"współczesność"},
    {question: "W jakich latach Amerykanie walczyli w Wietnamie?", answer: "W latach 1965-1973.", era:"współczesność"},
    {question: "Kiedy prezydent USA Ronald Reagan nazwał ZSRR \"imperium zła\"?", answer: "W 1983 r.", era:"współczesność"},
    {question: "Kiedy rozpadła się Czechosłowacja?", answer: "1 stycznia 1993 r.", era:"współczesność"}
]
